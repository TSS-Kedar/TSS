...
export const CottonComponent = ({currdoc,modifydoc}:any) => {
  return (
    <div className="grid">
      <div className="row">
        <PurposeVariety currdoc={currdoc} modifydoc={modifydoc} wd={3} yarntype={currdoc["yarntype"]} label={"Purpose"} />
      ...
      <div className="row">
        ...
        <Quality currdoc={currdoc} modifydoc={modifydoc} wd={3} />
        <div className={"col-3"}></div>
        <div className={"col-3"}></div>
      </div>
      <div className="row">
