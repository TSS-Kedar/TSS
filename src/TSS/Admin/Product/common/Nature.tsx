...
function Nature({currdoc,modifydoc,wd}:any) {
  return (
  <SelectInput wd={wd} label="Nature" options={typeoption} name="nature" currdoc={currdoc} section={"nature"} modifydoc={modifydoc} />
  )
}
