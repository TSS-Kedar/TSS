...
function BuyerCardList({data,cardclick,addNew}:any) {
  ...
  return (
    ...
    <div className="cards-row">{pageData.map((user:any)=>{
        return(<>
        <SupplierCard title={user.firstname+" "+user.lastname} mobile={user.primarynumber} email={user.email} companyname={user.companyname}  cardclick={cardclick} z_id={user.z_id} supid={user.supid}/>
